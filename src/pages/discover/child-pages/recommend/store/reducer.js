...
const initState = {     // 调用 Map返回一个 immutable类型的对象
    topBanners: [],     // 轮播图数据
    hotRecommend: [],   // 热门推荐数据
    newDisc: [],        // 新碟上架数据
    soarList: {},       // 排行榜-飙升榜
